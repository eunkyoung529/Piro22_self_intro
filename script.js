...
//         const sectionWidth = section.offsetWidth; //margin을 제외한 padding값, border값까지 계산한 값을 가지고 옴.
        
//         //event.clickX: 클릭한 위치의 X 좌표 (뷰포트 기준)
//         //section.getBoundingClickRect().left: section의 가장 왼쪽 가장자리의 X좌표 (뷰포트 기준)
...
//                 sections[index-1].computedStyleMap.display = 'flex';
//             }
//         }
//         else {
...
// fetch("https://m.search.naver.com/p/csearch/content/apirender.nhn?where=nexearch&pkid=387&u2=20030529&q=생년월일+운세&u1=f&u3=solar&u4=12&_=1719518803829")
...
//         fortuneSection.append(fortune);
//         fortuneSection.append(fortuneTextE);

//         const contactSection = document.querySelector(".contact");
//         contactSection.before(fotuneSection); //contact의 전에 fortune 추가
//         contactSection.after(fortuneSectioin);
//     })
